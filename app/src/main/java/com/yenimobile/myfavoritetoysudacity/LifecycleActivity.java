...
public class LifecycleActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBAKS_KEY = "callbacks";
    ...
    private static final ArrayList<String> mLifeCycleArraylist = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLifecycleDisplay = findViewById(R.id.lifecycle_tv);

        // TODO (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY, set that text on our TextView
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBAKS_KEY)){
                String allPreviousLifeCycleCallbacktexts = savedInstanceState.getString(LIFECYCLE_CALLBAKS_KEY);
                mLifecycleDisplay.setText(allPreviousLifeCycleCallbacktexts);
            }
        }

        for(String str: mLifeCycleArraylist){
            mLifecycleDisplay.append(str + "\n");
        }

        mLifeCycleArraylist.clear();
    ...
    protected void onStop() {
        ...
        mLifeCycleArraylist.add(ON_STOP);
    ...
    protected void onDestroy() {
        ...
        mLifeCycleArraylist.add(ON_DESTROY);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(LIFECYCLE_CALLBAKS_KEY, lifeCycleDisplayTextViewContents);
    }
