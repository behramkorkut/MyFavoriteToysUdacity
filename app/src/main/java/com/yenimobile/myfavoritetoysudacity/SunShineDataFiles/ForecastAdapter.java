package com.yenimobile.myfavoritetoysudacity.SunShineDataFiles;
...
import com.yenimobile.myfavoritetoysudacity.SunshineActivity;
...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private static final int VIEW_TYPE_FUTURE_DAYS = 1;
...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
         ...
         * Weather Icon *
         ****************/
        int weatherId = mCursor.getInt(SunshineActivity.INDEX_WEATHER_CONDITION_ID);
        int weatherImageId;
...
//          COMPLETED (17) Otherwise, throw an IllegalArgumentException
        ...
        long dateInMillis = mCursor.getLong(SunshineActivity.INDEX_WEATHER_DATE);
        ...
        double highInCelsius = mCursor.getDouble(SunshineActivity.INDEX_WEATHER_MAX_TEMP);
        /*
        ...
        double lowInCelsius = mCursor.getDouble(SunshineActivity.INDEX_WEATHER_MIN_TEMP);
        /*
         * If the user's preference for weather is fahrenheit, formatTemperature will convert
         * the temperature. This method will also append either °C or °F to the temperature
         * String.
