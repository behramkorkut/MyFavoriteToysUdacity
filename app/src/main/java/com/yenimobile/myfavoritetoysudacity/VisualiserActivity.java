...
import com.yenimobile.myfavoritetoysudacity.audioVisuals.AudioInputReader;
import com.yenimobile.myfavoritetoysudacity.audioVisuals.VisualizerView;
...
public class VisualiserActivity extends AppCompatActivity
    ...
    private void setUpSharedPreferences() {
        ...
        mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_triangle_key),
                getResources().getBoolean(R.bool.pref_show_triangle_default)));
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean(getString(R.string.pref_show_square_key),
    ...
    private void loadColorFromSharedPreferences(SharedPreferences sp){
        mVisualizerView.setColor(
                sp.getString(getString(R.string.pref_color_key), getString(R.string.pref_color_red_value)));
...
//-----------------------------------implementation on OnSharedPreferenceChangedListener----------------
    @Override
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))){
        ...
        }else if (key.equals(getString(R.string.pref_show_triangle_key))){
            ...
            mVisualizerView.setShowMid(sharedPreferences.getBoolean(
                    getString(R.string.pref_show_square_key),
                    getResources().getBoolean(R.bool.pref_show_square_default)
            ));
...
//-----------------------------------end of implementation on OnSharedPreferenceChangedListener----------------
}
